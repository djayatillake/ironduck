    ...
    match expr {
        ...
        sql::Expr::Extract { field, expr, .. } => {
            ...
            let field_str = match field {
                ...
                sql::DateTimeField::Microsecond | sql::DateTimeField::Microseconds => "MICROSECONDS",
                sql::DateTimeField::Millisecond | sql::DateTimeField::Milliseconds => "MILLISECONDS",
                sql::DateTimeField::Nanosecond | sql::DateTimeField::Nanoseconds => "NANOSECONDS",
